...
=======
					...
					<div class="col-md-4 content-middle">
						<div class="contact-form wow fadeInUp animated" data-wow-delay=".5s">
							<div class="skills-heading">
								<h3>Search Stock by Symbol</h3>
								<form  name="APIsearchForm" action="<?php echo basename ($_SERVER["PHP_SELF"]); ?>" method="get">
								<input name="searchText" placeholder=" Enter stock symbol" type="text"?>   
								<button class="submitButt" type="submit" value="Submit">Search</button>
								</form>
								<ul>
							...
							<div class="skills-heading">
									...
									<dl>
										<dt>
										  ...
										  <dd class="percentage percentage-16"><span class="text">Company 3: 16.09%</span></dd>
										  <dd class="percentage percentage-5"><span class="text">Company 4: 5.41%</span></dd>
										  <dd class="percentage percentage-2"><span class="text">Company 5: 1.62%</span></dd>
										  <dd class="percentage percentage-10"><span class="text">Company 6: 10.00%</span></dd>
										  <dd class="percentage percentage-7"><span class="text">Company 7: 7.00%</span></dd>
										  <dd class="percentage percentage-25"><span class="text">Company 8: 25.00%</span></dd>
										  <dd class="percentage percentage-32"><span class="text">Company 9: 32.00%</span></dd>
										  <dd class="percentage percentage-18"><span class="text">Company 10:18.00%</span></dd>
										</dl>
				...
				<div class="col-md-4 content-left">
					<div class="contact-form wow fadeInUp animated" data-wow-delay=".5s">
						<div class="skills-heading">
                                ...
                                <li>Shares Bought&nbsp;&nbsp;&nbsp;:$0.00</li>
                                <li>Shares Sold&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:$0.00</li>
                                <li>Profit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:$0.00</li>
								<li>Loss&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:$0.00</li>
